...
- Auto-discovery via metadata labels (`strands.io/agent_type: atomic`)
- JSON Schema validation for inputs and outputs
- Built-in test framework with fixture-based testing
- Scaffolding tools for rapid agent creation
- Compose into workflows as building blocks (Chain, DAG, Orchestrator, Graph)
