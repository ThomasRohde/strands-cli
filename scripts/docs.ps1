...
function Invoke-GenerateCLIDocs {
    Write-Header "Generating CLI documentation..."
    
    # CLI docs are auto-generated by mkdocs-typer plugin during build
    # Nothing to pre-generate, but we verify the plugin is configured
    Write-Host "CLI docs will be generated by mkdocs-typer plugin during build" -ForegroundColor Green
}

function Invoke-GenerateAPIDocs {
    Write-Header "Generating API documentation..."
    
    # API docs are auto-generated by mkdocstrings plugin during build
    # Nothing to pre-generate, but we verify the plugin is configured
    Write-Host "API docs will be generated by mkdocstrings plugin during build" -ForegroundColor Green
}

function Invoke-GenerateAll {
    Write-Header "Generating all auto-generated documentation..."
    
    # Schema docs (pre-generated)
    Invoke-GenerateSchemaDocs
    
    # CLI docs (generated during build by mkdocs-typer)
    Invoke-GenerateCLIDocs
    
    # API docs (generated during build by mkdocstrings)
