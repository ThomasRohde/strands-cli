...
- [ ] Install MkDocs dependencies (add to `pyproject.toml` optional deps)
- [ ] Create initial `mkdocs.yml` with Material theme
- [ ] Set up basic navigation structure (Tutorials/How-to/Explanation/Reference)
- [ ] Configure Material theme features (code copy, navigation tabs, TOC)
- [ ] Add essential markdown extensions (admonition, superfences, tabbed, snippets)
...
- [ ] Create **exit codes reference** from `exit_codes.py`
- [ ] Create **environment variables reference** from `config.py`
